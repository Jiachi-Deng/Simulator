#!/usr/bin/env bun
/**
 * Build script for standalone Simulator server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for Simulator
...
# Simulator Server — convenience entry point
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building Simulator Server ${version} for ${platform}-${arch} ===`);
