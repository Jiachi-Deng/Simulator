...
export const UpdatePreferencesSchema = z.object({
  ...
  includeCoAuthoredBy: z.boolean().optional().describe("Whether to opt in to the upstream 'Co-Authored-By: Craft Agent' trailer on git commits. Defaults to false for Simulator commits."),
});
...
- Do NOT include any text or tool calls after SubmitPlan - they will not be executed`,
  ...
  config_validate: `Validate Simulator configuration files.
...
Only use 'attachments' for existing file paths on disk — the tool reads them automatically.`,
  ...
  send_developer_feedback: `Send freeform feedback to the Simulator development team.
