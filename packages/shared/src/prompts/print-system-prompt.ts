#!/usr/bin/env bun
/**
 * Debug script to print the full Simulator system prompt with annotations.
...
printAnnotation('  2. Simulator Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Simulator additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Simulator Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
