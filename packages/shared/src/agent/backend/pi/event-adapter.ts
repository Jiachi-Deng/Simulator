 ...
 * Simulator's AgentEvent format for UI compatibility.
 *
...
/**
 * Maps Pi SDK events to SimulatorEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more SimulatorEvents.
   */
