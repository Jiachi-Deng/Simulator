#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for Simulator server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running Simulator server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for Simulator server
