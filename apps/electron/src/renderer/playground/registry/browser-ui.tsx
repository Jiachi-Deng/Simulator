...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  ...
  'long-names': [
    {
      ...
      title: 'Simulator Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/craft-agents-oss',
      title: 'Simulator OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
