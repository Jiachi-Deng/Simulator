...
This guide explains how to customize the visual theme of Simulator.

## Overview

Simulator uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
