...
echo "=== Building Simulator AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Simulator-x86_64.AppImage or Simulator-aarch64.AppImage
BUILT_APPIMAGE_NAME="Simulator-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Simulator-x64.AppImage, Simulator-arm64.AppImage
APPIMAGE_NAME="Simulator-${ARCH}.AppImage"
